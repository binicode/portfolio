...
export const knowledgeBaseSources: KnowledgeSourceEntry[] = [
  {
    ...
    content:
      `BACKGROUND & ROLE
I am Biniyam Abera, a Full-Stack Software Engineer with a background in Civil Engineering, transitioning into modern web development. My engineering foundation gives me a strong structural mindset, attention to detail, and a analytical approach to problem-solving. I specialize in building web applications with TypeScript, Node.js, Express, React, and MongoDB, focusing on backend architecture, clean API design, and AI features like Retrieval-Augmented Generation (RAG).
